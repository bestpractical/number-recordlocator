# This Makefile is for the Number::RecordLocator extension to perl.
#
...
#     DIR => []
#     DISTNAME => q[Number-RecordLocator]
#     NAME => q[Number::RecordLocator]
#     NO_META => q[1]
#     PL_FILES => {  }
...
FULLEXT = Number/RecordLocator
BASEEXT = RecordLocator
PARENT_NAME = Number
DLBASE = $(BASEEXT)
VERSION_FROM = 
OBJECT = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Number/RecordLocator.pm
...
TO_INST_PM = lib/Number/RecordLocator.pm

PM_TO_BLIB = lib/Number/RecordLocator.pm \
...
DISTNAME = Number-RecordLocator
DISTVNAME = Number-RecordLocator-0.001
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW)\
	  lib/Number/RecordLocator.pm $(INST_MAN3DIR)/Number::RecordLocator.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Number/RecordLocator.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  lib/Number/RecordLocator.pm blib/lib/Number/RecordLocator.pm 
	$(NOECHO) $(TOUCH) $@
